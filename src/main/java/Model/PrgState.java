...
public class PrgState {
    ...
    IDict<Integer, Pair<Integer, ArrayList<Integer>>> barrierTable;
    private static int threadCount = 1;
    private final int threadID;

    public PrgState(IStack<IStmt> stack, IDict<String, IValue> symTable,  IList<IValue> out, IDict<String, BufferedReader> fileTable, IHeap<Integer, IValue> heapTable,
                    IDict<Integer, Pair<Integer, ArrayList<Integer>>> barrierTable, IStmt prg){
        this.exeStack = stack;
    ...
    public IDict<Integer, Pair<Integer, ArrayList<Integer>>> getBarrierTable() {
